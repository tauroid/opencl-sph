...
set path=.,/usr/include,,,/usr/include/c++/4.9,/usr/include/c++/4.9.2
...
silent only
cd ~/Documents/Programming/phd-project/opencl-implementation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 particle_system.h
badd +0 particle_system.cpp
badd +1 testentry.cpp
badd +0 testmex.cpp
badd +0 macros.h
badd +0 simulation.cpp
badd +0 simulation.h
argglobal
silent! argdel *
argadd particle_system.h
set stal=2
edit particle_system.cpp
...
4
normal! zo
let s:l = 94 - ((54 * winheight(0) + 27) / 55)
